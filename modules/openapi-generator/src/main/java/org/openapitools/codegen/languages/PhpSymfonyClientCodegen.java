...
public class PhpSymfonyClientCodegen extends AbstractPhpCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private final Logger LOGGER = LoggerFactory.getLogger(PhpSymfonyClientCodegen.class);
    ...
    @Setter protected String composerProjectName = "client-bundle";
    ...
    protected String serviceDirName = "Client";
    ...
    public String getName() {
        return "php-symfony-client";
    }

    public String getHelp() {
        return "Generates a php-symfony-client client.";
    }

    public PhpSymfonyClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "php-symfony-client";
        apiPackage = "Apis";
        modelPackage = "Models";
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("api_client.mustache", toSrcPath(apiPackage, srcBasePath), "AbstractClient.php"));
    ...
    public ModelsMap postProcessModels(ModelsMap objs) {
        ...
        for (CodegenProperty var : model.vars) {
            ...
            var.vendorExtensions.put("x-size", model.vars.size());
            var.vendorExtensions.put("x-index", i);
            var.vendorExtensions.put("x-last-var", i == varSize);
